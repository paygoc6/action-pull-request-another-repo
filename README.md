...
## Variables
* source_folders: The folders to be moved. Uses the same syntax as the `cp` command. Incude the path for any files not in the repositories root directory.
* destination_repo: The repository to place the file or directory in.
* destination_folders: [optional] The folders in the destination repository to place the file in, if not the root directory.
